...
<script>
    ...
    function updateFormVisibility() {
        ...
        if (attendance === 'some_attending') {
            ...
            if (stayContainer) {
                ...
                if (stayingSelect) stayingSelect.setAttribute('required', 'required');
            }
        }

        if (attendance === 'attending' || attendance === 'all_attending') {
            dietaryContainer.classList.remove('hidden');
            if (stayContainer) {
                stayContainer.classList.remove('hidden');
                if (stayingSelect) stayingSelect.setAttribute('required', 'required');
    ...
    if (stayingSelect) stayingSelect.addEventListener('change', updateDinnerVisibility);
